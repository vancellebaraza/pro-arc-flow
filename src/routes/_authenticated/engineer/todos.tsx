...
export const Route = createFileRoute("/_authenticated/engineer/todos")({
  component: EngineerTodos,
});
...
function EngineerTodos() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const [{ data: profileRows }, { data: todoRows, error: todoError }] = await Promise.all([
      ...
      toast.error(error instanceof Error ? error.message : "Unable to load to-do list");
    } finally {
      setLoading(false);
    }
  }, [weekStart]);
  ...
  return (
    <div className="p-4 md:p-8 fade-in">
      <div className="mb-6">
        <h1 className="text-2xl md:text-3xl font-semibold tracking-tight">To Do List</h1>
