...
const ClipboardPlus = createLucideIcon("clipboard-plus", __iconNode$o);
const __iconNode$n = [
...
const Container = createLucideIcon("container", __iconNode$m);
const __iconNode$l = [
  [
    "path",
    {
...
const Paintbrush = createLucideIcon("paintbrush", __iconNode$a);
const __iconNode$9 = [
  ["path", { d: "M5 12h14", key: "1ays0h" }],
