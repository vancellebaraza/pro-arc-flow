...
import { B as BANK_DETAILS } from "./services-BNXDMItn.mjs";
const BRAND = [218, 31, 38];
...
function generateInspectionPdf(input) {
  const doc = new jspdf_node_minExports.jsPDF();
...
function generateWorksheetPdf(w) {
  const doc = new jspdf_node_minExports.jsPDF();
...
export {
  generateWorksheetPdf as a,
  generateInspectionPdf as b,
  downloadCsv as d,
  generateQuotationPdf as g
};
