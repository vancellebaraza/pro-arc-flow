...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DgvUF53z.mjs");
...
const manifest = {
  "11f87da97981c4722d94b0e74955e403bbd681423eb21cdb8af48e04c314fe60": {
    functionName: "ensureFixedAccounts_createServerFn_handler",
    importer: () => import("./setup.functions-Ds3FgZjG.mjs")
  },
  "34289704121d8b127eb7af3e6b02559dca8d18fa9f17685a81266a054a6657e8": {
    functionName: "getProjectContacts_createServerFn_handler",
    importer: () => import("./whatsapp.actions-B6kREpom.mjs")
  },
  "94fd1a8c385a25b379e468cd77e370ae6976769f2bf564761f7cee0204e16c2e": {
    functionName: "logWhatsAppAction_createServerFn_handler",
    importer: () => import("./whatsapp.actions-B6kREpom.mjs")
  },
  "bcdee306dc21b5ba28a0566471f76de3fe258d06de3e9683a2fb5059df9316e0": {
    functionName: "chatWithAssistant_createServerFn_handler",
    importer: () => import("./ai.functions-DEpqzOLl.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DdPd7JgK.mjs").then((n) => n.r),
    import("./start-D-aYn4ej.mjs"),
